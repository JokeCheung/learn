...
class SelectBoxPainter extends CustomPainter {
  ...
  Paint painter=Paint()..color=Colors.blue..strokeWidth=2..style = PaintingStyle.stroke;

  @override
  void paint(Canvas canvas, Size size) {
    if (posInRoot != null) {
      print("SelectBoxPainter paint posInRoot=$posInRoot");
      canvas.drawRect(posInRoot!, painter);
    }
  }
