...
// import 'package:flutter/material.dart' hide SpellCheckConfiguration,TextSelectionPoint,buildTextSpanWithSpellCheckSuggestions,
// TextSelectionOverlay,TextSelectionGestureDetectorBuilder,TextSelectionHandleControls,TextSelectionControls,ClipboardStatus,
// ClipboardStatusNotifier,LiveTextInputStatusNotifier,LiveTextInputStatus,TextSelectionToolbarAnchors;
import 'package:flutter/material.dart' hide SpellCheckConfiguration,buildTextSpanWithSpellCheckSuggestions,TextSelectionPoint,
TextSelectionOverlay,TextSelectionGestureDetectorBuilder,TextSelectionHandleControls,TextSelectionControls,ClipboardStatus,
ClipboardStatusNotifier,LiveTextInputStatusNotifier,LiveTextInputStatus,TextSelectionToolbarAnchors;
import 'package:flutter/rendering.dart' hide VerticalCaretMovementRun,RenderEditable,TextSelectionPoint;
import 'package:flutter/scheduler.dart';
import 'package:flutter/services.dart';
//替换文件，避免EditableTextContextMenuBuilder引用源码的editable_text
...
class EditableTextState extends State<EditableText> with AutomaticKeepAliveClientMixin<EditableText>, WidgetsBindingObserver, TickerProviderStateMixin<EditableText>, TextSelectionDelegate, TextInputClient implements AutofillClient {
  ...
  void _scheduleShowCaretOnScreen({required bool withAnimation}) {
    // print("_scheduleShowCaretOnScreen");
    // debugPrintStack();
    ...
    SchedulerBinding.instance.addPostFrameCallback((Duration _) {
      ...
      // print("animateTo2 targetOffset.offset=${targetOffset.offset}");
      if (withAnimation) {
        // print("${_scrollController.hashCode} animateTo2");
  ...
  void userUpdateTextEditingValue(TextEditingValue value, SelectionChangedCause? cause) {
    // debugPrintStack();
    FileLog.o("userUpdateTextEditingValue");
...
class _UpdateTextSelectionVerticallyAction<T extends DirectionalCaretMovementIntent> extends ContextAction<T> {
  ...
  void invoke(T intent, [BuildContext? context]) {
    ...
    FileLog.o("———————————————————————————————UpdateSelectionIntent invoke———————————————————————————————");
    // FileLog.o("invoke _verticalMovementRun==${_verticalMovementRun.hashCode}");
    ...
    //intent is ExtendSelectionVerticallyToAdjacentLineIntent
    ...
    FileLog.o("shouldMove==$shouldMove");
    FileLog.o("intent.forward==${intent.forward}");
    ...
    FileLog.o("currentRun.current==${currentRun.current}");
    FileLog.o("newExtent==$newExtent");
    FileLog.o("newSelection=${newSelection}");
    Actions.invoke(
      context!,
