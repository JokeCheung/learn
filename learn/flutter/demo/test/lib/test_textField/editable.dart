...
class VerticalCaretMovementRun implements Iterator<TextPosition> {
  ...
  MapEntry<Offset, TextPosition> _getTextPositionForLine(int lineNumber) {
    ...
    FileLog.o("_getTextPositionForLine newOffset=$newOffset");
    FileLog.o("_getTextPositionForLine closestPosition=$closestPosition");
    FileLog.o("_getTextPositionForLine position=$position");
    return position;
  }
